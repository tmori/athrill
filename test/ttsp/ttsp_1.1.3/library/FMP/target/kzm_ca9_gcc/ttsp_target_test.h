...
#define TTSP_INTNO_F      0x00025	/* PE1割込み番号F */

#define TTSP_INTNO_PE2_A  0x00026	/* PE2割込み番号A */
#define TTSP_INTNO_PE2_B  0x00027	/* PE2割込み番号B */
#define TTSP_INTNO_PE2_C  0x00028	/* PE2割込み番号C */
#define TTSP_INTNO_PE2_D  0x00029	/* PE2割込み番号D */
#define TTSP_INTNO_PE2_E  0x0002a	/* PE2割込み番号E */
#define TTSP_INTNO_PE2_F  0x0002b	/* PE2割込み番号F */

#define TTSP_INTNO_PE3_A  0x0002c	/* PE3割込み番号A */
#define TTSP_INTNO_PE3_B  0x0002e	/* PE3割込み番号B */
#define TTSP_INTNO_PE3_C  0x0002f	/* PE3割込み番号C */
#define TTSP_INTNO_PE3_D  0x00030	/* PE3割込み番号D */
 ...
 *  割込み番号(異常値)
 */
#define TTSP_INVALID_INTNO       0x10100	/* PE1ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE2   0x20100	/* PE2ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE3   0x30100	/* PE3ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE4   0x40100	/* PE4ターゲットでサポートしていない割込み番号 */
...
#define TTSP_INHNO_PE2_A   0x20026		/* PE2割込みハンドラ番号A */
#define TTSP_INHNO_PE2_B   0x20027		/* PE2割込みハンドラ番号B */
#define TTSP_INHNO_PE2_C   0x20028		/* PE2割込みハンドラ番号C */

#define TTSP_INHNO_PE3_A   0x3002c		/* PE3割込みハンドラ番号A */
#define TTSP_INHNO_PE3_B   0x3002e		/* PE3割込みハンドラ番号B */
#define TTSP_INHNO_PE3_C   0x3002f		/* PE3割込みハンドラ番号C */
