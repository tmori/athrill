...
#  の責任を負わない．
#
#  $Id: Spinlock.rb 9 2012-09-11 01:47:48Z nces-shigihara $
#
require "common/bin/sc_object/SCObject.rb"
require "ttc/bin/sc_object/Spinlock.rb"
...
module CommonModule
  #===================================================================
  # クラス名: Spinlock
  # 概    要: スピンロックの情報を処理するクラス
  #===================================================================
  class Spinlock < SCObject
    ...
    def initialize(sObjectID, hObjectInfo, aPath, bIsPre)
      ...
      super(sObjectID, hObjectInfo, TSR_OBJ_SPINLOCK, aPath, bIsPre)

      @sRefAPI     = FNC_REF_SPN
      @sRefStrType = TYP_T_TTSP_RSPN
      @sRefStrVar  = GRP_VAR_TYPE[TYP_T_TTSP_RSPN]
    end
    ...
    def gc_config(cElement)
      ...
      cElement.set_config("#{API_CRE_SPN}(#{@sObjectID}, {#{KER_TA_NULL}});", @hState[TSR_PRM_CLASS]) # [IMCodeElement]スピンロックを生成する静的API
    end
  end
end
