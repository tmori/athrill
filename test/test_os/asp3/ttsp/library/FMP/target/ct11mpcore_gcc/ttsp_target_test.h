...
#define TTSP_INTNO_D      0x00030	/* PE1割込み番号D */
#define TTSP_INTNO_E      0x00031	/* PE1割込み番号E */
#define TTSP_INTNO_F      0x00032	/* PE1割込み番号F */

#define TTSP_INTNO_PE2_A  0x00023	/* PE2割込み番号A */
#define TTSP_INTNO_PE2_B  0x00026	/* PE2割込み番号B */
#define TTSP_INTNO_PE2_C  0x00027	/* PE2割込み番号C */
#define TTSP_INTNO_PE2_D  0x00033	/* PE2割込み番号D */
#define TTSP_INTNO_PE2_E  0x00034	/* PE2割込み番号E */
#define TTSP_INTNO_PE2_F  0x00035	/* PE2割込み番号F */

#define TTSP_INTNO_PE3_A  0x00028	/* PE3割込み番号A */
#define TTSP_INTNO_PE3_B  0x00029	/* PE3割込み番号B */
#define TTSP_INTNO_PE3_C  0x0002a	/* PE3割込み番号C */
#define TTSP_INTNO_PE3_D  0x00036	/* PE3割込み番号D */
#define TTSP_INTNO_PE3_E  0x00037	/* PE3割込み番号E */
#define TTSP_INTNO_PE3_F  0x00038	/* PE3割込み番号F */

#define TTSP_INTNO_PE4_A  0x0002b	/* PE4割込み番号A */
#define TTSP_INTNO_PE4_B  0x0002e	/* PE4割込み番号B */
#define TTSP_INTNO_PE4_C  0x0002f	/* PE4割込み番号C */
 ...
 *  割込み番号(異常値)
 */
#define TTSP_INVALID_INTNO       0x10081	/* PE1ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE2   0x20081	/* PE2ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE3   0x30081	/* PE3ターゲットでサポートしていない割込み番号 */
#define TTSP_INVALID_INTNO_PE4   0x40081	/* PE4ターゲットでサポートしていない割込み番号 */
#define TTSP_NOT_SET_INTNO       0x10032	/* PE1割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
#define TTSP_NOT_SET_INTNO_PE2   0x20032	/* PE2割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
#define TTSP_NOT_SET_INTNO_PE3   0x30032	/* PE3割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
#define TTSP_NOT_SET_INTNO_PE4   0x40032	/* PE4割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
 ...
 *  割込みハンドラ番号(正常値)
 */
#define TTSP_INHNO_A       0x10020		/* PE1割込みハンドラ番号A */
#define TTSP_INHNO_B       0x10021		/* PE1割込みハンドラ番号B */
#define TTSP_INHNO_C       0x10022		/* PE1割込みハンドラ番号C */

#define TTSP_INHNO_PE2_A   0x20023		/* PE2割込みハンドラ番号A */
#define TTSP_INHNO_PE2_B   0x20026		/* PE2割込みハンドラ番号B */
#define TTSP_INHNO_PE2_C   0x20027		/* PE2割込みハンドラ番号C */

#define TTSP_INHNO_PE3_A   0x30028		/* PE3割込みハンドラ番号A */
#define TTSP_INHNO_PE3_B   0x30029		/* PE3割込みハンドラ番号B */
#define TTSP_INHNO_PE3_C   0x3002a		/* PE3割込みハンドラ番号C */

#define TTSP_INHNO_PE4_A   0x4002b		/* PE4割込みハンドラ番号A */
#define TTSP_INHNO_PE4_B   0x4002e		/* PE4割込みハンドラ番号B */
#define TTSP_INHNO_PE4_C   0x4002f		/* PE4割込みハンドラ番号C */
 ...
 *  CPU例外ハンドラ番号(正常値)
 */
#define TTSP_EXCNO_A      0x10002	/* CPU例外発生元のコンテキストへreturn可能(SWC) */
#define TTSP_EXCNO_B      0x10001	/* 本番号でCPU例外を発生させるテストケースはない */
#define TTSP_EXCNO_PE2_A  0x20002	/* PE2 SWC */
#define TTSP_EXCNO_PE2_B  0x20001	/* 本番号でCPU例外を発生させるテストケースはない */
#define TTSP_EXCNO_PE3_A  0x30002	/* PE3 SWC */
#define TTSP_EXCNO_PE3_B  0x30001	/* 本番号でCPU例外を発生させるテストケースはない */
#define TTSP_EXCNO_PE4_A  0x40002	/* PE4 SWC */
#define TTSP_EXCNO_PE4_B  0x40001	/* 本番号でCPU例外を発生させるテストケースはない */
