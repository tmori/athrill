 ...
 *  割込み番号(正常値)
 */
#define TTSP_INTNO_A   16	/* 割込み番号A */
#define TTSP_INTNO_B   17	/* 割込み番号B */
#define TTSP_INTNO_C   18	/* 割込み番号C */
#define TTSP_INTNO_D   19	/* 割込み番号D */
#define TTSP_INTNO_E   20	/* 割込み番号E */
#define TTSP_INTNO_F   22	/* 割込み番号F */

/*
 *  割込み番号(異常値)
 */
#define TTSP_INVALID_INTNO  80	/* ターゲットでサポートしていない割込み番号 */
#define TTSP_NOT_SET_INTNO  23	/* 割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
 ...
 *  CPU例外ハンドラ番号(正常値)
 */
#define TTSP_EXCNO_A  6       /* Usage Fault */
