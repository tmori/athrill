...
#
KERNEL_COBJS_TARGET="target_config.o target_timer.o prc_config.o ttsp_target_timer.o ttsp_target_test.o"
...
simulation()
{
	...
	cmd /c "nios2-gdb-server.exe -r --instance=0 --cable=USB-Blaster --stop"
	cmd /c "nios2-gdb-server.exe -r --instance=1 --cable=USB-Blaster --stop"
	# Load and Start
	cmd /c "nios2-gdb-server.exe --instance=0 --no-verify --cable=USB-Blaster --go fmp.srec"
	cmd /c "nios2-gdb-server.exe --instance=1 --no-verify --cable=USB-Blaster --wait-target-exit "
}
