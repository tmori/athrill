...
#
KERNEL_COBJS_TARGET="core_config.o chip_config.o ttsp_chip_timer.o mpcore.o ct11mpcore.o target_config.o ttsp_target_test.o"
...
simulation()
{
	qemu-system-arm.exe -cpu arm11mpcore -M realview-eb-mpcore -smp 4 -serial vc:80Cx40C -serial vc:80Cx40C -serial vc:80Cx40C -serial vc:80Cx40C -no-reboot -icount auto --kernel fmp.exe
}
