...
simulation()
{
        qemu-system-arm -cpu cortex-a9 -M xilinx-zynq-a9 -smp $PROCESSOR_NUM -serial vc:80Cx40C -serial vc:80Cx40C -serial vc:80Cx40C -serial vc:80Cx40C -no-reboot -m 1024M -kernel fmp
}
