...
#  の責任を負わない．
#
#  $Id: Execption.rb 9 2012-09-11 01:47:48Z nces-shigihara $
#
...
module CommonModule
  ...
  class CPUException < ProcessUnit
    ...
    def gc_config(cElement)
      ...
      cElement.set_config("#{API_DEF_EXC}(#{@hState[TSR_PRM_EXCNO]}, {#{KER_TA_NULL}, #{@sObjectID.downcase}});", @hState[TSR_PRM_CLASS])
    end
  end
end
