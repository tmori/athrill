...
#  の責任を負わない．
#
#  $Id: IniRtn.rb 9 2012-09-11 01:47:48Z nces-shigihara $
#
require "common/bin/process_unit/ProcessUnit.rb"
require "ttc/bin/process_unit/IniRtn.rb"
...
module CommonModule
  #===================================================================
  # クラス名: IniRtn
  # 概    要: 初期化ルーチンの情報を処理するクラス
  #===================================================================
  class IniRtn < ProcessUnit
    #=================================================================
    # 概  要: 初期化ルーチンの初期化
    #=================================================================
    def initialize(sObjectID, hObjectInfo, aPath, bIsPre)
      ...
      super(sObjectID, hObjectInfo, TSR_OBJ_INIRTN, aPath, bIsPre)
