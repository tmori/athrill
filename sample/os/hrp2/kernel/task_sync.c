 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: task_sync.c 338 2010-08-23 14:51:44Z ertl-hiro $
 */
...
#ifndef LOG_DIS_WAI_ENTER
#define LOG_DIS_WAI_ENTER(tskid)
#endif /* LOG_DIS_WAI_ENTER */

#ifndef LOG_DIS_WAI_LEAVE
#define LOG_DIS_WAI_LEAVE(ercd)
#endif /* LOG_DIS_WAI_LEAVE */

#ifndef LOG_IDIS_WAI_ENTER
#define LOG_IDIS_WAI_ENTER(tskid)
#endif /* LOG_DIS_WAI_ENTER */

#ifndef LOG_IDIS_WAI_LEAVE
#define LOG_IDIS_WAI_LEAVE(ercd)
#endif /* LOG_DIS_WAI_LEAVE */

#ifndef LOG_ENA_WAI_ENTER
#define LOG_ENA_WAI_ENTER(tskid)
#endif /* LOG_ENA_WAI_ENTER */

#ifndef LOG_ENA_WAI_LEAVE
#define LOG_ENA_WAI_LEAVE(ercd)
#endif /* LOG_ENA_WAI_LEAVE */

#ifndef LOG_IENA_WAI_ENTER
#define LOG_IENA_WAI_ENTER(tskid)
#endif /* LOG_ENA_WAI_ENTER */

#ifndef LOG_IENA_WAI_LEAVE
#define LOG_IENA_WAI_LEAVE(ercd)
#endif /* LOG_ENA_WAI_LEAVE */
...
dis_wai(ID tskid)
{
  ...
  error_exit:
	LOG_DIS_WAI_LEAVE(ercd);
	return(ercd);
}

#endif /* TOPPERS_dis_wai */

/*
 *  待ち禁止状態への遷移（非タスクコンテキスト用）
 */
#ifdef TOPPERS_idis_wai
...
#endif /* TOPPERS_idis_wai */

/*
 *  待ち禁止状態の解除
 */
#ifdef TOPPERS_ena_wai
...
ena_wai(ID tskid)
{
	...
	t_lock_cpu();
	if (TSTAT_DORMANT(p_tcb->tstat) || !(p_tcb->waifbd)) {
		ercd = E_OBJ;
	}
	else {
		p_tcb->waifbd = false;
...
#endif /* TOPPERS_ena_wai */

/*
 *  待ち禁止状態の解除（非タスクコンテキスト用）
 */
#ifdef TOPPERS_iena_wai
