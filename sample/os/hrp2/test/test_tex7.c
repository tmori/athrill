 ...
 * 【テストの目的】
 *
 *  システム状態に対する通常操作1と通常操作2を許可されていないユーザド
 *  メイン内において，タスクからタスク例外処理ルーチンを起動する処理を
 *  網羅的にテストする．テストの内容は，タスク例外処理に関するテスト
 *  (1)と同等だが，通常操作1と通常操作2を許可されていないことによる振舞
 *  いの違いを吸収するよう修正している．
 *
 * 【テスト項目】
 *
