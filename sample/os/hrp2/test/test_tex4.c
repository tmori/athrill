 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: test_tex4.c 837 2012-12-26 15:09:59Z ertl-hiro $
 */
 ...
 * 【テストの目的】
 *
 *  ユーザドメインに属するタスクに対して，割込みハンドラ（アラームハン
 *  ドラ）およびCPU例外ハンドラからタスク例外処理ルーチンを起動する処理
 *  を網羅的にテストする．テストの内容は，タスク例外処理に関するテスト
 *  (2)と同じ．
 *
 * 【テスト項目】
 *
