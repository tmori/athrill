 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: logtask.c 837 2012-12-26 15:09:59Z ertl-hiro $
 */
 ...
 */
ER
_logtask_logtask_flush(uint_t count)
{
	T_SYSLOG_RLOG	rlog;
	T_SERIAL_RPOR	rpor;
	ER				ercd, rercd;
 ...
 */
ER_UINT
extsvc_logtask_flush(intptr_t count, intptr_t par2, intptr_t par3,
								intptr_t par4, intptr_t par5, ID cdmid)
{
	return((ER_UINT) _logtask_logtask_flush((uint_t) count));
}
