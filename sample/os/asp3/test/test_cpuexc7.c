 ...
 *  の責任を負わない．
 * 
 *  $Id: test_cpuexc7.c 346 2015-07-18 02:12:08Z ertl-hiro $
 */
 ...
 *  先度マスク全解除状態，ディスパッチ禁止状態で発生したCPU例外における
 *  システム状態のテスト．
 *
 * 【テスト項目】
 *
 *  いずれも，タスクコンテキスト，割込ロック解除状態，CPUロック解除状態，
 *  割込み優先度マスク全解除状態，ディスパッチ禁止状態で発生したCPU例外
 *  において，
 *
 ...
 *	== CPUEXC ==
 *	3:	state(true, false, true, true, false)				... (A)(C)
 ...
 *		RETURN
 *	== TASK1（続き）==
 *	5:	state(false, false, true, true, false)				... (D)(E)(F)
 *		ipm(TIPM_ENAALL)
 *	6:	END
 */
