 ...
 *  の責任を負わない．
 * 
 *  $Id: test_cpuexc9.c 346 2015-07-18 02:12:08Z ertl-hiro $
 */
 ...
 *  先度マスク＝TMIN_INTPRI，ディスパッチ許可状態で発生したCPU例外にお
 *  けるシステム状態のテスト．
 *
 * 【テスト項目】
 *
 *  いずれも，タスクコンテキスト，割込ロック解除状態，CPUロック解除状態，
 *  割込み優先度マスク＝TMIN_INTPRI，ディスパッチ許可状態で発生したCPU
 *  例外において，
 *
