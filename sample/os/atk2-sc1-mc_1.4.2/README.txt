		...
		TOPPERS/ATK2-SC1-MC（Release 1.4.2）
        ＜ATK2-SC1-MC Readmeファイル＞

本ファイルでは，ATK2-SC1-MC を使用する上で必要な情報を紹介します．
...
クラス1の機能を実装したマルチコア用リアルタイムカーネルです．

【ジェネレータのバージョンに関する注意】

ATK2-SC1-MC Release 1.4.0以降では，TOPPERS新世代カーネル用コンフィギュ
レータ（cfg）(ジェネレータと呼ぶ)の最新版（1.9.6）の機能を用いている．
1.9.4以前のバージョンでは動作しないので注意すること．

【最初に読むべきドキュメント】

ATK2-SC1-MCのユーザーズマニュアルが，doc/user.txtにあります．ATK2-SC1
-MCを使用する場合には，まずはこのドキュメントからお読み下さい．

【ファイルの閲覧にあたって】

ATK2-SC1-MCのドキュメント（プレーンテキストファイル）およびソースファ
イルを読む際には，TABを4に設定してください．

【利用条件】

ATK2-SC1-MCの利用条件は，各ファイルの先頭に表示されているTOPPERSライ
...
ATK2-SC1-MCをより良いものにするためのご意見等を歓迎します．
ATK2-SC1-MCに関する質問やバグレポート，ご意見等は，TOPPERSプロジェクト
...
ATK2-SC1-MCを，TOPPERSプロジェクトから公開することを前提に，未サポート
