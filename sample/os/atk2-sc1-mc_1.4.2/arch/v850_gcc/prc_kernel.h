 ...
 *  の責任を負わない．
 *
 *  $Id: prc_kernel.h 549 2015-12-30 10:06:17Z ertl-honda $
 */
...
extern uint32	v850_cpu_exp_no_table[];

/* CPU例外発生時，プログラムカウンタ（PC - 4）を保持する変数 */
extern uint32	v850_cpu_exp_pc_table[];

/* CPU例外発生時，スタックポインタを保持する変数 */
extern uint32	v850_cpu_exp_sp_table[];
