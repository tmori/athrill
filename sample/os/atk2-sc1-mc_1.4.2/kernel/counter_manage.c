 ...
 *  の責任を負わない．
 *
 *  $Id: counter_manage.c 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
...
#ifdef CFG_USE_PARAMETERACCESS
	get_my_p_ccb()->temp_errorhook_par1.cntid = CounterID;
	get_my_p_ccb()->temp_errorhook_par2.p_val = Value;
#endif /* CFG_USE_PARAMETERACCESS */
...
GetElapsedValue(CounterType CounterID, TickRefType Value, TickRefType ElapsedValue)
{
  ...
  exit_errorhook:
	...
	get_my_p_ccb()->temp_errorhook_par1.cntid = CounterID;
	get_my_p_ccb()->temp_errorhook_par2.p_val = Value;
	get_my_p_ccb()->temp_errorhook_par3.p_eval = ElapsedValue;
#endif /* CFG_USE_PARAMETERACCESS */
