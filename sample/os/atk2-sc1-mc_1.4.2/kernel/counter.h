 ...
 *  の責任を負わない．
 *
 *  $Id: counter.h 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
 ...
 */
#define get_cntcb(cntid)	(p_cntcb_table[(cntid)])
 ...
 */
#define CNTID(p_cntcb)	((CounterType) (((p_cntcb)->p_cntinib) - cntinib_table))
...
typedef struct counter_initialization_block {
	...
	CoreIdType		coreid;                             /* 割付けコア */
	const OSAPINIB	*p_osapinib;                        /* 所属するOSアプリケーション初期化ブロック */
} CNTINIB;
 ...
 */
extern CNTCB * const		p_cntcb_table[];
