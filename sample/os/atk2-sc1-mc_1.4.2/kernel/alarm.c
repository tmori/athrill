 ...
 *  の責任を負わない．
 *
 *  $Id: alarm.c 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
...
GetAlarmBase(AlarmType AlarmID, AlarmBaseRefType Info)
{
  ...
  exit_errorhook:
	...
	get_my_p_ccb()->temp_errorhook_par2.p_info = Info;
...
#ifdef CFG_USE_PARAMETERACCESS
	get_my_p_ccb()->temp_errorhook_par1.almid = AlarmID;
	get_my_p_ccb()->temp_errorhook_par2.p_tick = Tick;
#endif /* CFG_USE_PARAMETERACCESS */
...
#ifdef CFG_USE_PARAMETERACCESS
	get_my_p_ccb()->temp_errorhook_par1.almid = AlarmID;
	get_my_p_ccb()->temp_errorhook_par2.incr = increment;
	get_my_p_ccb()->temp_errorhook_par3.cycle = cycle;
#endif /* CFG_USE_PARAMETERACCESS */
...
alarm_expire(CNTEXPINFO *p_cntexpinfo, CNTCB *p_cntcb)
{
	...
	p_ccb->p_currentosap = p_almcb->p_alminib->p_osapinib;
