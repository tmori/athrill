 ...
 *  の責任を負わない．
 *
 *  $Id: osap.h 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
...
/*
 *  OSAPINIBからOSアプリケーションIDを取り出すためのマクロ
 */
#define OSAPID(p_osapinib)	((ApplicationType) ((p_osapinib) - (osapinib_table)))
 ...
 */
struct os_application_initialization_block {
