 ...
 *  の責任を負わない．
 *
 *  $Id: t_syslog.h 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
...
#define LOG_TYPE_INSHUTALLCORES	UINT_C(0x1f)    /* OS内部からのShutdownAllCoresの呼び出し */
#define LOG_TYPE_WSUSALL		UINT_C(0x20)    /* スピンロックをラッピングする全割込み禁止 */
#define LOG_TYPE_WRSMALL		UINT_C(0x21)    /* スピンロックをラッピングする全割込み禁止解除 */
#define LOG_TYPE_WSUSOSI		UINT_C(0x22)    /* スピンロックをラッピングするOS割込み禁止 */
#define LOG_TYPE_WRSMOSI		UINT_C(0x23)    /* スピンロックをラッピングするOS割込み禁止解除 */
