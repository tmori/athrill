 ...
 *  の責任を負わない．
 *
 *  $Id: kernel_fncode.h 2401 2017-03-14 09:09:24Z witz-itoyo $
 */

#ifndef TOPPERS_KERNEL_FNCODE_H
#define TOPPERS_KERNEL_FNCODE_H

#define TMAX_SVCID	UINT_C(55)

#define TFN_STARTOS						UINT_C(0)
#define TFN_SHUTDOWNALLCORES			UINT_C(1)
...
#define TFN_CHECKTASKOWNERSHIP			UINT_C(35)
#define TFN_CHECKISROWNERSHIP			UINT_C(36)
#define TFN_CHECKALARMOWNERSHIP			UINT_C(37)
#define TFN_CHECKCOUNTEROWNERSHIP		UINT_C(38)
#define TFN_CHECKSCHEDULETABLEOWNERSHIP	UINT_C(39)
#define TFN_GETAPPLICATIONID			UINT_C(40)
#define TFN_IOC_SEND_GENERIC			UINT_C(41)
#define TFN_IOC_WRITE_GENERIC			UINT_C(42)
#define TFN_IOC_RECEIVE_GENERIC			UINT_C(43)
#define TFN_IOC_READ_GENERIC			UINT_C(44)
#define TFN_IOC_EMPTY_QUEUE_GENERIC		UINT_C(45)
#define TFN_GETCOREID					UINT_C(46)
#define TFN_GETNUMBEROFACTIVATEDCORES	UINT_C(47)
#define TFN_STARTCORE					UINT_C(48)
#define TFN_STARTNONAUTOSARCORE			UINT_C(49)
#define TFN_GETSPINLOCK					UINT_C(50)
#define TFN_RELEASESPINLOCK				UINT_C(51)
#define TFN_TRYTOGETSPINLOCK			UINT_C(52)
#define TFN_RAISEINTERCOREINTERRUPT		UINT_C(53)
#define TFN_DISABLEINTERRUPTSOURCE		UINT_C(54)
#define TFN_ENABLEINTERRUPTSOURCE		UINT_C(55)
