 ...
 *  の責任を負わない．
 *
 *  $Id: histogram.h 2401 2017-03-14 09:09:24Z witz-itoyo $
 */
 ...
 *  実行時間分布計測の初期化
 */
extern boolean init_hist(ObjectIDType histid, uint32 maxval, uint32 *histarea);

/*
 *  実行時間計測の開始
 */
extern boolean begin_measure(ObjectIDType histid);

/*
 *  実行時間計測の終了
 */
extern boolean end_measure(ObjectIDType histid);

/*
 *  実行時間分布計測の表示
 */
extern boolean print_hist(ObjectIDType histid);
