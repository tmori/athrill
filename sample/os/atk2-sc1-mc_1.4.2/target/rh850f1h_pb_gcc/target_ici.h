 ...
 *  の責任を負わない．
 *
 *  $Id: target_ici.h 546 2015-12-29 01:11:53Z ertl-honda $
 */
...
#ifndef TOPPERS_TARGET_ICI_H
#define TOPPERS_TARGET_ICI_H

/*
 *  コア間割込みとして使用するIPICのチャネル
 */
#define ICI_IPIC_CH	0

/*
 *  コア間割込みの割込み優先度
 */
#ifndef INTPRI_ICI0
#define INTPRI_ICI0	1
#endif /* INTPRI_ICI0 */

#ifndef INTPRI_ICI1
#define INTPRI_ICI1	1
#endif /* INTPRI_ICI1 */

/*
 *  コア間割込み番号と優先度取得用マクロ
 */
#define GET_ICI_INTNO(coreid)	target_ici_intno_table[coreid]
#define GET_ICI_INTPRI(coreid)	target_ici_intpri_table[coreid]
 ...
 *  プロセッサ依存モジュール（V850用）
 */
#include "v850_gcc/prc_ici.h"

#endif /* TOPPERS_TARGET_ICI_H */
