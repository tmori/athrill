...
$  の責任を負わない．
$
$  $Id: target_offset.tf 66 2014-09-17 04:50:37Z fujisft-shigihara $
$

$
$       オフセットファイル生成用テンプレートファイル（HSBV850E2FG4用）
$
...
$
$  コア依存テンプレートのインクルード（V850E2用）
$
$INCLUDE "v850esfk3_gcc/prc_offset.tf"$
