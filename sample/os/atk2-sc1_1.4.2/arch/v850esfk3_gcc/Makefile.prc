...
#  の責任を負わない．
#
#  $Id: Makefile.prc 540 2015-12-29 01:00:01Z ertl-honda $
#
...
#  プロセッサ依存部ディレクトリ名の定義
#
PRCDIR = $(KNLDIR)/arch/$(PRC)_$(TOOL)

#
#  コンパイルオプション
#
INCLUDES := $(INCLUDES) -I$(PRCDIR) -I$(KNLDIR)/arch/$(TOOL)
...
#  アーキテクチャの切り替え
#
COPTS := $(COPTS) -mv850es  -Wa,-mno-bcond17
...
$(HIDDEN_OBJS:.o=.d): %.d: %.S
	@$(PERL) $(KNLDIR)/utils/makedep -C $(CC) \
