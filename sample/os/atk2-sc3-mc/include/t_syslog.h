...
#define LOG_TYPE_INSHUTALLCORES	UINT_C(0x1c)    /* OS内部からのShutdownAllCoresの呼び出し */
#define LOG_TYPE_WSUSALL		UINT_C(0x1d)    /* スピンロックをラッピングする全割込み禁止 */
#define LOG_TYPE_WRSMALL		UINT_C(0x1e)    /* スピンロックをラッピングする全割込み禁止解除 */
#define LOG_TYPE_WSUSOSI		UINT_C(0x1f)    /* スピンロックをラッピングするOS割込み禁止 */
#define LOG_TYPE_WRSMOSI		UINT_C(0x20)    /* スピンロックをラッピングするOS割込み禁止解除 */
