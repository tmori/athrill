 ...
 *  の責任を負わない．
 *
 *  $Id: log_output.h 425 2015-12-07 08:06:19Z witz-itoyo $
 */
 ...
 */
extern void	_syslog_syslog_printf(const char8 *format, const uintptr *p_args,
 ...
 *  いて出力する
 */
extern void _syslog_syslog_print(const SYSLOG *p_syslog, void (*outputc)(char8 c));
...
syslog_printf(const char8 *format, const uintptr *p_args, void (*outputc)(char8 c))
{
	...
	prm.index = KERLIBSLG_ID_SYSLOG_PRINTF;
	prm.p_format = format;
	prm.p_args = p_args;
	prm.outputc = outputc;
...
syslog_print(const SYSLOG *p_syslog, void (*outputc)(char8 c))
{
	...
	prm.index = KERLIBSLG_ID_SYSLOG_PRINT;
