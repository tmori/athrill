 ...
 *  の責任を負わない．
 *
 *  $Id: Os.h 500 2015-12-23 07:10:02Z ertl-ishikawa $
 */
...
#define OSServiceId_CheckSpinlockAccess			((OSServiceIdType) 0xa8)
...
LOCAL_INLINE _ErrorHook_Par
get_error_par1(void)
{
	_ErrorHook_Par errorhook_par;
...
#define OSError_ShutdownAllCores_Error()						(get_error_par1().error)
...
#define OSError_GetApplicationState_Application()				(get_error_par1().applid)
#define OSError_GetApplicationState_Value()						(get_error_par2().p_appstat)
#define OSError_CallTrustedFunction_FunctionIndex()				(get_error_par1().tfnid)
#define OSError_CallTrustedFunction_FunctionParams()			(get_error_par2().tfnpr)
#define OSError_CheckISRMemoryAccess_ISRID()					(get_error_par1().isrid)
#define OSError_CheckISRMemoryAccess_Address()					(get_error_par2().adr)
#define OSError_CheckISRMemoryAccess_Size()						(get_error_par3().sz)
#define OSError_CheckTaskMemoryAccess_TaskID()					(get_error_par1().tskid)
#define OSError_CheckTaskMemoryAccess_Address()					(get_error_par2().adr)
#define OSError_CheckTaskMemoryAccess_Size()					(get_error_par3().sz)
#define OSError_CheckTaskAccess_ApplID()						(get_error_par1().applid)
#define OSError_CheckTaskAccess_TaskID()						(get_error_par2().tskid)
#define OSError_CheckISRAccess_ApplID()							(get_error_par1().applid)
#define OSError_CheckISRAccess_ISRID()							(get_error_par2().isrid)
#define OSError_CheckAlarmAccess_ApplID()						(get_error_par1().applid)
#define OSError_CheckAlarmAccess_AlarmID()						(get_error_par2().almid)
#define OSError_CheckResourceAccess_ApplID()					(get_error_par1().applid)
#define OSError_CheckResourceAccess_ResID()						(get_error_par2().resid)
#define OSError_CheckCounterAccess_ApplID()						(get_error_par1().applid)
#define OSError_CheckCounterAccess_CounterID()					(get_error_par2().cntid)
#define OSError_CheckScheduleTableAccess_ApplID()				(get_error_par1().applid)
#define OSError_CheckScheduleTableAccess_ScheduleTableID()		(get_error_par2().schtblid)
...
#define OSError_CheckSpinlockAccess_ApplID()					(get_error_par1().applid)
#define OSError_CheckSpinlockAccess_SpinlockId()				(get_error_par2().spnid)
...
#define OSError_TerminateApplication_Application()				(get_error_par1().applid)
#define OSError_TerminateApplication_RestartOption()			(get_error_par2().restartoption)
...
#define OBJECT_SPINLOCK			UINT_C(0x07)
...
#define TKERNEL_NAME	"TOPPERS/ATK2-SC3-MC"  /* カーネル名称（独自仕様） */
