 ...
 *  の責任を負わない．
 *
 *  $Id: target_ccb.h 549 2015-12-30 10:06:17Z ertl-honda $
 */

/*
 *  プロセッサ依存コア管理ブロック（RH850F1H_PB用）
 */
#ifndef TOPPERS_TARGET_CCB_H
#define TOPPERS_TARGET_CCB_H

/*
 *  OS内部データ構造の排他ロックのロック単位
 */
#define TTYPE_KLOCK	C_KLOCK
 ...
 *  ネイティブスピンの場合の最大数
 */
#define TMAX_NATIVE_SPN	0xffffffffU

/*
 *  コア間割込みのバイパス処理を使用する
 */
#define USE_ICI_DIS_HANDER_BYPASS

/*
 *  チップ依存モジュール（V850用）
 */
#include "v850_gcc/prc_ccb.h"
