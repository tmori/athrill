 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: Compiler_Cfg.h 187 2015-06-25 03:39:04Z t_ishikawa $
 */

#ifndef TOPPERS_COMPILER_CFG_H
#define TOPPERS_COMPILER_CFG_H

/*
 *  ATK2共通定義
 */
#ifndef UINT_C
#define UINT_C(val)		(val ## U)      /* 符号無し整数型の定数を作るマクロ */
#endif /* UINT_C */
 ...
 */
#ifndef offsetof
#define offsetof(structure, field)	((uintptr) & (((structure *) 0)->field))
#endif /* offsetof */

#ifndef alignof
#define alignof(type)	offsetof(struct { uint8 field1; type field2; }, field2)
#endif /* alignof */
#ifndef ALIGNED_TYPE    /* アラインメントのチェック */
#define aligntypeof(type)	offsetof(struct { uint8 field1; type field2; }, field2)
#define ALIGNED_TYPE(addr, type)	(boolean)((((uintptr) (addr)) & (alignof(type) - 1U)) == 0U)
#endif /* ALIGNED_TYPE */

#endif /* TOPPERS_COMPILER_CFG_H */
