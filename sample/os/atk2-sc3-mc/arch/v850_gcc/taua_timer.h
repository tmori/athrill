 ...
 *  の責任を負わない．
 *
 *  $Id: taua_timer.h 117 2014-12-10 03:58:03Z t_ishikawa $
 */

/*
 *		タイマドライバ（TAUA0 Timer用）
 */

#ifndef TOPPERS_TAUA0_TIMER_H
#define TOPPERS_TAUA0_TIMER_H
...
target_timer_get_current(void)
{
	...
	count = sil_reh_mem((void *) (TAUA0CNT(0)));
...
{
	return(x_probe_int(TAUA0_IRQ));
}

#endif /* TOPPERS_MACRO_ONLY */
#endif /* TOPPERS_TAUA0_TIMER_H */
