...
$DEFINE("CCB_p_runosap", offsetof_CCB_p_runosap)$
...
$DEFINE("CCB_run_trusted", offsetof_CCB_run_trusted)$
$DEFINE("CCB_pre_protection_supervised", offsetof_CCB_pre_protection_supervised)$
$DEFINE("CCB_term_osap_id_map", offsetof_CCB_term_osap_id_map)$
...
$DEFINE("CCB_p_ctxosap", offsetof_CCB_p_ctxosap)$
