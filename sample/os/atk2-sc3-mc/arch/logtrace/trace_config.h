 ...
 *  の責任を負わない．
 *
 *  $Id: trace_config.h 440 2015-12-09 12:34:23Z aisincom-nishioka $
 */
 ...
 *  マルチコア機能
 */
#define LOG_RASICI_ENTER(ISRID)							trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_RAISEINTERCOREINTERRUPT, (uintptr) (ISRID))
#define LOG_RASICI_LEAVE(ercd)							trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_RAISEINTERCOREINTERRUPT, (uintptr) (ercd))
#define LOG_GETCOREID_ENTER()							trace_1(LOG_TYPE_SVC | LOG_ENTER, TFN_GETCOREID)
#define LOG_GETCOREID_LEAVE(coreid)						trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_GETCOREID, (uintptr) (coreid))
#define LOG_STARTCORE_ENTER(CoreID)						trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_STARTCORE, (uintptr) (CoreID))
#define LOG_STARTCORE_LEAVE(CoreID, p_status)			trace_3(LOG_TYPE_SVC | LOG_LEAVE, TFN_STARTCORE, (uintptr) (CoreID), (((p_status) != NULL) ? (uintptr) (*(p_status)) : (0U)))
#define LOG_STARTNONAUTOSARCORE_ENTER(CoreID);			trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_STARTNONAUTOSARCORE, (uintptr) (CoreID))
#define LOG_STARTNONAUTOSARCORE_LEAVE(CoreID, p_status)	trace_3(LOG_TYPE_SVC | LOG_LEAVE, TFN_STARTNONAUTOSARCORE, (uintptr) (CoreID), (((p_status) != NULL) ? (uintptr) (*(p_status)) : (0U)))
#define LOG_GETNUMOFACTCORES_ENTER()					trace_1(LOG_TYPE_SVC | LOG_ENTER, TFN_GETNUMBEROFACTIVATEDCORES)
#define LOG_GETNUMOFACTCORES_LEAVE(activated_cores)		trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_GETNUMBEROFACTIVATEDCORES, (uintptr) (activated_cores))
#define LOG_SHUTDOWNALLCORES_ENTER(Error)				trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_SHUTDOWNALLCORES, (uintptr) (Error))
#define LOG_SHUTDOWNALLCORES_LEAVE(ercd)				trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_SHUTDOWNALLCORES, (uintptr) (ercd))

#define LOG_SHUTALLCORE_ENTER(ercd)						trace_1(LOG_TYPE_INSHUTALLCORES | LOG_ENTER, (uintptr) (ercd))
#define LOG_SHUTALLCORE_LEAVE()							trace_0(LOG_TYPE_INSHUTALLCORES | LOG_LEAVE)

/*
 *  スピンロック機能
 */
#define LOG_WSUSALL_ENTER()					trace_0(LOG_TYPE_WSUSALL | LOG_ENTER)
#define LOG_WSUSALL_LEAVE()					trace_0(LOG_TYPE_WSUSALL | LOG_LEAVE)
#define LOG_WRSMALL_ENTER()					trace_0(LOG_TYPE_WRSMALL | LOG_ENTER)
#define LOG_WRSMALL_LEAVE()					trace_0(LOG_TYPE_WRSMALL | LOG_LEAVE)
#define LOG_WSUSOSI_ENTER()					trace_0(LOG_TYPE_WSUSOSI | LOG_ENTER)
#define LOG_WSUSOSI_LEAVE()					trace_0(LOG_TYPE_WSUSOSI | LOG_LEAVE)
#define LOG_WRSMOSI_ENTER()					trace_0(LOG_TYPE_WRSMOSI | LOG_ENTER)
#define LOG_WRSMOSI_LEAVE()					trace_0(LOG_TYPE_WRSMOSI | LOG_LEAVE)
#define LOG_GETSPN_ENTER(spinlockid)		trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_GETSPINLOCK, (uintptr) (spinlockid))
#define LOG_GETSPN_LEAVE(ercd)				trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_GETSPINLOCK, (uintptr) (ercd))
#define LOG_RELSPN_ENTER(spinlockid)		trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_RELEASESPINLOCK, (uintptr) (spinlockid))
#define LOG_RELSPN_LEAVE(ercd)				trace_2(LOG_TYPE_SVC | LOG_LEAVE, TFN_RELEASESPINLOCK, (uintptr) (ercd))
#define LOG_TRYSPN_ENTER(spinlockid)		trace_2(LOG_TYPE_SVC | LOG_ENTER, TFN_TRYTOGETSPINLOCK, (uintptr) (spinlockid))
#define LOG_TRYSPN_LEAVE(ercd, p_success)	trace_3(LOG_TYPE_SVC | LOG_LEAVE, TFN_TRYTOGETSPINLOCK, (uintptr) (ercd), (((ercd) == E_OK) ? (uintptr) (*(p_success)) : (0U)))
