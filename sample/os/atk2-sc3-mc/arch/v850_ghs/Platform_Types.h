 ...
 *  の責任を負わない．
 *
 *  $Id: Platform_Types.h 117 2014-12-10 03:58:03Z t_ishikawa $
 */
 ...
 */
#define DEFINE_VAR_SEC(type, var, sec)	        type __attribute__((section(sec))) var
#define DEFINE_VAR_SEC_NOBITS(type, var, sec)	type __attribute__((section(sec))) var
#define DEFINE_VAR_SSTACK(type, var)			type __attribute__((section(".prsv_kernel"), aligned(4))) var
#define DEFINE_VAR_USTACK(type, var, sec)		type __attribute__((section(sec), aligned(16))) var
