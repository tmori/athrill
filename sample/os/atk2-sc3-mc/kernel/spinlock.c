 ...
 *  の責任を負わない．
 *
 *  $Id: spinlock.c 431 2015-12-08 11:59:08Z witz-itoyo $
 */
...
GetSpinlock(SpinlockIdType SpinlockId)
{
	...
	CHECK_RIGHT(p_spncb->p_spninib->acsbtmp);
  ...
  d_exit_errorhook:
	...
	p_ccb->_errorhook_par1.spnid = SpinlockId;
...
TryToGetSpinlock(SpinlockIdType SpinlockId, TryToGetSpinlockType *Success)
{
	...
	CHECK_MEM_WRITE(Success, TryToGetSpinlockType);
...
#ifdef CFG_USE_PARAMETERACCESS
	p_ccb->_errorhook_par1.spnid = SpinlockId;
	p_ccb->_errorhook_par2.tryspntype = Success;
#endif /* CFG_USE_PARAMETERACCESS */
