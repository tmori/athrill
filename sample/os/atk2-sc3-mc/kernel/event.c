 ...
 *  の責任を負わない．
 *
 *  $Id: event.c 425 2015-12-07 08:06:19Z witz-itoyo $
 */
...
SetEvent(TaskType TaskID, EventMaskType Mask)
{
  ...
  errorhook_start:
	...
	get_my_p_ccb()->_errorhook_par2.mask = Mask;
...
ClearEvent(EventMaskType Mask)
{
  ...
  exit_errorhook:
	x_nested_lock_os_int();
#ifdef CFG_USE_PARAMETERACCESS
	p_ccb->_errorhook_par1.mask = Mask;
#endif /* CFG_USE_PARAMETERACCESS */
...
#ifdef CFG_USE_PARAMETERACCESS
	get_my_p_ccb()->_errorhook_par1.tskid = TaskID;
	get_my_p_ccb()->_errorhook_par2.p_mask = Event;
#endif /* CFG_USE_PARAMETERACCESS */
