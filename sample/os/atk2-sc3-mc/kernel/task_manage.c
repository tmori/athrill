 ...
 *  の責任を負わない．
 *
 *  $Id: task_manage.c 465 2015-12-10 11:16:18Z witz-itoyo $
 */
...
ChainTask(TaskType TaskID)
{
  ...
  errorhook_start:
#ifdef CFG_USE_PARAMETERACCESS
	my_p_ccb->_errorhook_par1.tskid = TaskID;
#endif /* CFG_USE_PARAMETERACCESS */
...
GetTaskID(TaskRefType TaskID)
{
  ...
  exit_errorhook:
	x_nested_lock_os_int();
#ifdef CFG_USE_PARAMETERACCESS
	p_ccb->_errorhook_par1.p_tskid = TaskID;
#endif /* CFG_USE_PARAMETERACCESS */
...
#ifdef CFG_USE_PARAMETERACCESS
	get_my_p_ccb()->_errorhook_par1.tskid = TaskID;
	get_my_p_ccb()->_errorhook_par2.p_stat = State;
#endif /* CFG_USE_PARAMETERACCESS */
