 ...
 *  の責任を負わない．
 *
 *  $Id: syslog.h 425 2015-12-07 08:06:19Z witz-itoyo $
 */
...
/*
 *  非信頼OSアプリケーション用システムログ機能の初期化
 */
extern void syslog_initialize(void);

/*
 *  非信頼OSアプリケーション用出力すべきログ情報の重要度の設定
 */
extern StatusType syslog_msk_log(uint32 lowmask);
